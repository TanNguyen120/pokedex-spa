...
const ItemsAttributeList = ({ itemList, attributeName }) => {
  return (
    <div className=' rounded-lg bg-slate-100 grid-cols-1'>
      <div className=' text-base font-semibold text-left capitalize p-4 text-slate-500'> Items That Have {attributeName} attribute:</div>
      <div className=' rounded-lg bg-slate-50 m-4 p-4 grid lg:grid-cols-10 md:grid-cols-6 grid-cols-4 gap-4 '>
        {
