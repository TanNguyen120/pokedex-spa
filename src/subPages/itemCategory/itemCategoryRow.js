...
const ItemCategoryRow = ({ itemName }) => {
    return (
        <div className='grid grid-cols-1 px-4 bg-slate-100 rounded-lg'>
            <div className=''>
                <Link to={`/t-pokedex/item/${itemName}`} className=' rounded-lg   grid grid-cols-1 hover:scale-125 hover:cursor-pointer'>
