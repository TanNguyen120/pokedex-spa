...
const FlavorColumn = ({ flavorDetails }) => {
    ...
    return (
        <div className=' h-52 bg-slate-200 rounded-lg py-2 px-9 grid grid-cols-1 text-center'>
            ...
            <Link className=' mt-2 hover:cursor-pointer hover:text-lg hover:text-rose-700 hover:underline text-slate-500' to={`/t-pokedex/berries/flavor/${flavorDetails.flavor.name}`}>
                <div >
