            ...
            <div className='bg-slate-300 rounded-lg items-center m-1'>
                <div className='bg-white rounded-lg justify-center flex flex-col md:flex-row py-2 items-center'>
                    {pokemon.type.map((type, index) => (
                        <div className={`${typeToColor(type.type.name)} md:w-20 md:h-6 rounded-md text-white text-center text-base font-semibold border border-indigo-600 m-1 px-3 font-mono hover:cursor-pointer`} key={index}>
