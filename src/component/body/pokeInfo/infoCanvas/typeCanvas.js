        ...
        <div className='bg-slate-300 rounded-lg items-center m-2 '>
            ...
            <div className='bg-white rounded-lg justify-center grid grid-cols-2 md:grid-cols-3 m-2 p-3'>
                {types.map((type, index) => (
                    <div className={`${typeToColor(type.type.name)} rounded-md text-white text-center text-lg font-semibold border border-indigo-600 m-1 px-3 font-mono`} key={index}>
