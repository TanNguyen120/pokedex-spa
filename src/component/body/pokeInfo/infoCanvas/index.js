        ...
        <div className='bg-slate-400 grid grid-cols-1 md:grid-cols-2 rounded-lg '>
            ...
            <div className='grid grid-cols-1'>
                <div className='grid grid-cols-2'>
                    <InfoSmallComponent tile="Weight" detail_info={(pokemon.weight * 0.1).toFixed(3)} metric=" kg" icon={weightIcon} />
                    <InfoSmallComponent tile="Height" detail_info={(pokemon.height * 0.1).toFixed(3)} metric=" m" icon={heightIcon} />
                </div>
